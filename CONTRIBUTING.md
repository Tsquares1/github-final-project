...
Please start by reading as much as you can about Micro-Finance Project:

Wiki (you are already here🧐)
Slack (we regularly discuss topics here before implementing)
Contributing Guidelines
Code of Conduct
What can I contribute?
There are many ways to contribute to Mico-Finance Project and many of them do not involve writing code or building hardware. Here's a few ideas to get started:

Develop hardware and firmware for sensor
Develop dashboard
Develop mobile app
Develop seismology scripts
